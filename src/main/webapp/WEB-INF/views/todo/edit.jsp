...
<html>
  ...
  <body>
    ...
    <div class="container main">
      ...
      <c:url var="action" value="/todo/edit" />
      <form:form action="${action}" commandName="todo" method="POST">
        <div class="row">
          <div class="col-md-2" >
            <form:label path="id"><spring:message code="todo.label.id"/>:</form:label>
          </div>
          <div class="col-md-5" >
        ...
        <div class="row">
          <div class="col-md-8" >
            <input type="submit" value="<spring:message code="todo.update.page.submit.label"/>"/>
          </div>
        </div>
      </form:form>
    </div>
